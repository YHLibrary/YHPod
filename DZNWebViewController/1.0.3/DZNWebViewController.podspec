...
s.version      = "1.0.3"
s.summary      = "DZNWebViewController."
...
s.description  = <<-DESC
this is DZNWebViewController
DESC

s.homepage     = "https://github.com/YHLibrary/DZNWebViewController"
...
s.source       = { :git => "https://github.com/YHLibrary/DZNWebViewController.git", :tag => s.version.to_s }
